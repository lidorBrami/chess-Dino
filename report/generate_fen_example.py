"""Generate a figure showing: Input image -> Model -> FEN output + board visualization."""
import sys
import os
import numpy as np
import torch
...
if __name__ == '__main__':
    ...
    fig.tight_layout()
    fig.savefig(os.path.join(OUT_DIR, 'input_to_fen_example.png'), dpi=150, bbox_inches='tight', facecolor='white')
    plt.close()
    print(f"Saved {os.path.join(OUT_DIR, 'input_to_fen_example.png')}")
